...
/// <summary>
/// Orchestratore centralizzato per l'aggiornamento o l'inserimento del grafo di contenuti nel database.
/// Riusato da YuGiOh, Pokemon e MTG content seeder per eliminare la duplicazione (DUP-002).
/// </summary>
public static class ContentGraphSeeder
{
    public static async Task<ContentSeedResult> SeedGraphAsync(
